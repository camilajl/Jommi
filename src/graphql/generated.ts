...
export type GetUserByIdQuery = { __typename?: 'Query', userById: { __typename?: 'User', id: string, enabled: boolean, name?: string | null, email: string, roles: Array<{ __typename?: 'Role', name: string }> } };
